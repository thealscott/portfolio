<header>
    <h2 id="intro" title="You like to read between the lines, huh?">
        Nivea<br>
        Wrapped in Friendship<br>
    </h2>

    <p id="intro_addendum">
        This christmas campaign app used the Facebook API to find pictures of you and a friend together and then composite those pics into a design which would be printed on wrapping paper and sent to the user when they purchased a gift&nbsp;pack.
    </p>
</header>
...
<!--    <div class="button_wrapper">
    ...
    <div class="video_wrapper">
        <video controls preload="auto">
           ...
           <source src="/videos/gift_wrap_walkthrough.webm" type="video/webm" />
        </video>
    </div>
